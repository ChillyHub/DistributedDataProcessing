...
public class Position {
    ...
    public Position move(CarServer.Direction direction) {
        switch(direction){
            ...
            case UP_LEFT: return new Position(row - 1, col - 1);
            case UP_RIGHT: return new Position(row - 1, col + 1);
            case DOWN_LEFT: return new Position(row + 1, col - 1);
            case DOWN_RIGHT: return new Position(row + 1, col + 1);

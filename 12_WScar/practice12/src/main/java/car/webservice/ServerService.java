 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://server/", wsdlLocation = "http://localhost:8090/CarServer?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8090/CarServer?wsdl");
